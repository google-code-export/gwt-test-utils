...
public class DOMFragmentParser implements XMLDocumentHandler {
  ...
  protected static final String[] RECOGNIZED_PROPERTIES = {
      ERROR_HANDLER, CURRENT_ELEMENT_NODE,};
  ...
  public void processingInstruction(final String target, final XMLString data,
    ...
    if (XMLChar.isValidName(s)) {
      final ProcessingInstruction pi = fDocument.createProcessingInstruction(
          target, s);
   ...
   * recognize the feature, and if it does recognize it, it might not be able to
   * fulfill the request.
   * 
