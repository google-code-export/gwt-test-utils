 ...
 * <p/>
 * A selector has a tag name, a combinator and a list of {@linkplain Specifier
 * specifiers}.
 * 
 * @see <a href="http://www.w3.org/TR/css3-selectors/#selector-syntax">Selector
...
class Selector {
   ...
   * Combinators
   * 
   * @see <a href="http://www.w3.org/TR/css3-selectors/#combinators">Combinators
   *      description</a>
   */
  ...
  /**
   * Create a new instance with the tag name set to the value of
   * {@link #UNIVERSAL_TAG}, and with the combinator set to
   * {@link Combinator#DESCENDANT}. The list of {@linkplain #specifiers
   * specifiers} will be set to {@code null}.
   */
  public Selector() {
  ...
  /**
   * Create a new instance with the specified tag name, combinator and list of
   * specifiers.
   * 
   * @param tagName The tag name to set.
   * @param combinator The combinator to set.
