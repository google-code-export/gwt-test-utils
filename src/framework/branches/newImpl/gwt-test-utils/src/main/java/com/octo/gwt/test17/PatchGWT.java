...
import com.octo.gwt.test17.internal.patcher.dom.BodyElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.ButtonElementPatcher;
...
import com.octo.gwt.test17.internal.patcher.dom.DivElementPatcher;
...
import com.octo.gwt.test17.internal.patcher.dom.FieldSetElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.FormElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.IFrameElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.ImageElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.InputElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.LabelElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.LegendElementPatcher;
...
import com.octo.gwt.test17.internal.patcher.dom.TableCellElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.TableColElementPatcher;
import com.octo.gwt.test17.internal.patcher.dom.TableElementPatcher;
...
public class PatchGWT {
	...
	public static void init() throws Exception {
		...
		PatchUtils.patch(BodyElement.class, new BodyElementPatcher());
		PatchUtils.patch(BRElement.class, null);
		PatchUtils.patch(ButtonElement.class, new ButtonElementPatcher());
		PatchUtils.patch(DivElement.class, new DivElementPatcher());
		...
		PatchUtils.patch(FieldSetElement.class, new FieldSetElementPatcher());
		PatchUtils.patch(FormElement.class, new FormElementPatcher());
		PatchUtils.patch(IFrameElement.class, new IFrameElementPatcher());
		PatchUtils.patch(ImageElement.class, new ImageElementPatcher());
		PatchUtils.patch(InputElement.class, new InputElementPatcher());
		PatchUtils.patch(LabelElement.class, new LabelElementPatcher());
		PatchUtils.patch(LegendElement.class, new LegendElementPatcher());
		...
		PatchUtils.patch(TableCellElement.class, new TableCellElementPatcher());
		PatchUtils.patch(TableColElement.class, new TableColElementPatcher());
		PatchUtils.patch(TableElement.class, new TableElementPatcher());
		PatchUtils.patch(TableRowElement.class, new TableRowElementPatcher());
		PatchUtils.patch(TableSectionElement.class, new TableSectionElementPatcher());
		PatchUtils.patch(TextAreaElement.class, new TextAreaElementPatcher());
