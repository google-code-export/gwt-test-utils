...
public class DOMImplUserSubClassPatcher extends AutomaticPatcher {
	...
	public static void insertChild(DOMImpl domImpl, Element userParent,
		...
		com.google.gwt.dom.client.Element parent = ElementUtils
				.castToDomElement(userParent);
		com.google.gwt.dom.client.Element child = ElementUtils
				.castToDomElement(userChild);
	...
	public static Element getChild(DOMImpl domImpl, Element userElem, int index) {
		com.google.gwt.dom.client.Element elem = ElementUtils
				.castToDomElement(userElem);
		if (index >= elem.getChildNodes().getLength()) {
			return null;
		}

		return ElementUtils
				.castToUserElement((com.google.gwt.dom.client.Element) elem
						.getChildNodes().getItem(index));
	}
	...
	public static int getChildIndex(DOMImpl domImpl, Element parent,
		...
		com.google.gwt.dom.client.Element domElem = ElementUtils
				.castToDomElement(child);
