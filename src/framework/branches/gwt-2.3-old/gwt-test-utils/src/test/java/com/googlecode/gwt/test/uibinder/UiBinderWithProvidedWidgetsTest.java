...
public class UiBinderWithProvidedWidgetsTest extends GwtTestTest {
  ...
  public void instanciation() {
    ...
    assertEquals("first custom text setup in ui.xml",
        w.firstProvidedLabel.getCustomText());
    ...
    assertEquals("second custom text setup in ui.xml",
        w.secondProvidedLabel.getCustomText());
