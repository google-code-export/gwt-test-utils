...
public class CsvRunner {
  ...
  private Method getCsvMethod(Class<?> clazz, String methodName) {
    ...
    if (classCsvMethods == null) {
      ...
      Map<Method, CsvMethod> csvMethods = GwtTestReflectionUtils.getAnnotatedMethod(
  ...
  public Object getNodeValue(Object o, Node node) {
    ...
    while (currentNode != null) {
      ...
      if (!ok) {
        ...
        if (m == null) {
          m = GwtTestReflectionUtils.getMethod(current.getClass(), "get"
              + currentName);
        }
        if (m != null) {
          try {
  ...
  private Object findInList(final Object current, final Method m, Node mapEq,
    ...
    Method countM = GwtTestReflectionUtils.getMethod(current.getClass(),
        m.getName() + "Count");
    if (countM == null) {
