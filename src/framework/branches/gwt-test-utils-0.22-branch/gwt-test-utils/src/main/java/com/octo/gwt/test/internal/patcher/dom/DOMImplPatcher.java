...
public class DOMImplPatcher extends AutomaticPatcher {
  ...
  public static String getAttribute(Object domImpl, Element elem, String name) {
    PropertyContainer propertyContainer = PropertyContainerHelper.getProperty(
  ...
  public static String getTagName(Object domImpl, Element elem) {
    ...
    return (tagName != null) ? tagName
        : (String) GwtTestReflectionUtils.getStaticFieldValue(elem.getClass(),
            "TAG");
  }
  ...
  public static void cssSetOpacity(Object domImpl, Style style, double value) {
    String opacityField = GwtTestReflectionUtils.getStaticFieldValue(
  ...
  private static OverrideNodeList<Node> getChildNodeList(Object domImpl,
      Node node) {
