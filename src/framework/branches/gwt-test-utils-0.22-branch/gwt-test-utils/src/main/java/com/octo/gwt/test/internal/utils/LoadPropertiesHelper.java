...
public class LoadPropertiesHelper {
   ...
   *           stream.
   * @throws IllegalArgumentException if a malformed Unicode escape appears in
   *           the input.
   * @since 1.6
   */
  public static synchronized void load(Properties properties, Reader reader)
      throws IOException {
  ...
  private static void load0(Properties properties, LineReader lr)
      throws IOException {
