  ...
  private static InputStream getModuleConfigurationFile() {
    ...
    if (fileName == null) {
      throw new IllegalArgumentException(
          "GWT module configuration file (.gwt.xml) to be used is not set. You should override "
              + AbstractGwtConfigurableTest.class.getSimpleName()
              + ".getCurrentTestedModuleFile() method in your test class");
    }
