...
public class NodeTest {
	...
	public void initElement() {
		n = JavaScriptObjectFactory.createJavaScriptObject(Node.class);
	}
...
@Test
	...
	public void checkNodeType() {
		...
		Assert.assertEquals(Node.TEXT_NODE, JavaScriptObjectFactory.createJavaScriptObject(Text.class).getNodeType());
	}
