...
class GwtInjectingAnnotationEngine implements AnnotationEngine {
    ...
    for (Field field : clazz.getDeclaredFields()) {
      ...
      if (null != field.getAnnotation(Spy.class)
        ...
        try {
          ...
          throw new MockitoException("Problems injecting dependencies in "
              + field.getName(), e);
        } finally {
  ...
  public void process(Class<?> context, Object testClass) {
    ...
    for (Field field : fields) {
      if (field.isAnnotationPresent(InjectMocks.class)) {
        MockitoConfiguration.assertNoAnnotations(InjectMocks.class, field,
            Mock.class, org.mockito.MockitoAnnotations.Mock.class,
            com.googlecode.gwt.test.Mock.class, Captor.class);
  ...
  private void injectMocks(Object testClass) {
    ...
    new DefaultInjectionEngine().injectMocksOnFields(mockDependents, mocks,
        testClass);
  }
}
