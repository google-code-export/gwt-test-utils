...
public class ClientBundleTest extends GwtTestTest {
	...
	public void checkCssResource() {
		// Setup
		TestCssResource testCssResource = MyClientBundle.INSTANCE
				.testCssResource();
		...
		String testStyleOnSpecificElement = testCssResource
				.testStyleOnSpecificElement();
		String testStyleOnSpecificStyle = testCssResource
				.testStyleOnSpecificStyle();
		...
		Assert.assertEquals("testStyleOnSpecificElement",
				testStyleOnSpecificElement);
		Assert.assertEquals("testStyleOnSpecificStyle",
				testStyleOnSpecificStyle);
	...
	public void checkDataResource() {
		// Setup
		DataResource testDataResource = MyClientBundle.INSTANCE
				.testDataResource();
	...
	public void checkGetExternalResourceText() {
		...
		Assert.assertTrue(text
				.startsWith("function __gwt_initWindowCloseHandler(beforeunload, unload) {"));
	}
	...
	public void checkImageResource() {
		// Setup
		ImageResource testImageResource = MyClientBundle.INSTANCE
				.testImageResource();
