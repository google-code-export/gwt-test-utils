...
public class ElementPatcher {
  ...
  public static boolean getPropertyBoolean(Element element, String propertyName) {
    PropertyContainer propertyContainer = PropertyContainerHelper.getObject(
  ...
  public static Style getStyle(Element element) {
    return PropertyContainerHelper.getObject(element, STYLE_FIELD);
  }
  ...
  static void initClass(CtClass c) throws Exception {
    ...
    cons.insertAfter(PropertyContainerHelper.getCodeSetProperty("this",
        ...
        + ";");
    cons.insertAfter(PropertyContainerHelper.getCodeSetProperty("this",
        PROPERTY_MAP_FIELD, PropertyContainerHelper.getConstructionCode())
        + ";");
    cons.insertAfter(PropertyContainerHelper.getCodeSetProperty("this",
        CLASSNAME_FIELD, "\"\"") + ";");
  }
