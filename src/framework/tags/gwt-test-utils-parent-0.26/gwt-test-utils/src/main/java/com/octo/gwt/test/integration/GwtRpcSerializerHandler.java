...
/**
 * <p>
 * An interface which exposes one callback method to be called in order to
 * simulate GWT-RPC serialization. It is called when simulating the
 * serialization of RPC method parameters from the client and when returning the
 * method result from the server.
 * </p>
 * 
 * <p>
 * The used instance of GwtRpcSerializerHandler is specified by
 * {@link RemoteServiceCreateHandler#getSerializerHandler()}, which can be
 * overriden.
 * </p>
 * 
 * @author Gael Lazzari
...
public interface GwtRpcSerializerHandler {
	 ...
	 * 
	 * @param <T>
	 *            Type type of the object to serialize.
	 * @param o
