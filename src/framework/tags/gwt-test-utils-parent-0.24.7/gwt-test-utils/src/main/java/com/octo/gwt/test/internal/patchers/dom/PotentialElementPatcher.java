...
public class PotentialElementPatcher extends AutomaticPropertyContainerPatcher {
  ...
  public static boolean isPotential(JavaScriptObject o) {
    return PropertyContainerHelper.getPropertyBoolean(o, POTENTIALELEMENT_TAG);
  }

  @PatchMethod
  public static Element resolve(Element maybePotential) {
    if (isPotential(maybePotential)) {
      UIObject o = PropertyContainerHelper.getProperty(maybePotential,
          POTENTIALELEMENT_UIOBJECT);
      GwtReflectionUtils.callPrivateMethod(o, "resolvePotentialElement");

      return PropertyContainerHelper.getProperty(maybePotential,
  ...
  public static Element setResolver(PotentialElement pe, UIObject resolver) {
    PropertyContainerHelper.setProperty(pe, POTENTIALELEMENT_UIOBJECT, resolver);
