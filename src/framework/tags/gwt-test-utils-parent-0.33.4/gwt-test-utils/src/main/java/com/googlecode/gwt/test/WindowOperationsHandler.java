...
/**
 * Handler where are redirect {@link Window} operations. Its methods are
...
public class WindowOperationsHandler {
   ...
   * {@link Window#alert(String)}. This default implementation throws an
  ...
  public void alert(String msg) {
    throw new UnsupportedOperationException(
        "Not handled call to Window.alert(msg)");
  }

  /**
   * Handler's method called during the invocation of
   * {@link Window#confirm(String)}. This default implementation throws an
   * UnsupportedOperationException.
   * 
   * @param msg the message to be displayed.
  ...
  public boolean confirm(String msg) {
    throw new UnsupportedOperationException(
        "Not handled call to Window.confirm(msg)");
  }

  /**
   * Handler's method called during the invocation of
   * {@link Window#open(String, String, String)}. This implementation does
   * nothing.
   * 
  ...
  /**
   * Handler's method called during the invocation of
   * {@link Window#prompt(String, String)}. This default implementation throws
