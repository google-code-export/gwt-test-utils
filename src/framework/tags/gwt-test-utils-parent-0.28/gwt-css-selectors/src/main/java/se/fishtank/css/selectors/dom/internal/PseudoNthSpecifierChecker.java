...
/**
 * A {@link NodeTraversalChecker} that check if a node matches the {@code nth-*}
 * {@linkplain PseudoNthSpecifier pseudo-class specifier} set.
 * 
...
public class PseudoNthSpecifierChecker extends NodeTraversalChecker {
   ...
   * 
   * @see <a
   *      href="http://www.w3.org/TR/css3-selectors/#nth-child-pseudo"><code>:nth-child</code>
   *      pseudo-class</a>
   */
   ...
   * 
   * @see <a
   *      href="http://www.w3.org/TR/css3-selectors/#nth-last-child-pseudo"><code>:nth-last-child</code>
   *      pseudo-class</a>
   */
   ...
   * 
   * @see <a
   *      href="http://www.w3.org/TR/css3-selectors/#nth-last-of-type-pseudo"><code>:nth-last-of-type</code>
   *      pseudo-class</a>
   */
   ...
   * 
   * @see <a
   *      href="http://www.w3.org/TR/css3-selectors/#nth-of-type-pseudo"><code>:nth-of-type</code>
   *      pseudo-class</a>
   */
