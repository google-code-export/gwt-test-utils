 ...
 * 
 * @see <a
 *      href="http://www.w3.org/TR/css3-selectors/#pseudo-classes">Pseudo-classes</a>
 * 
 * @author Christer Sandberg
 */
public class PseudoNthSpecifier implements Specifier {
  ...
  /**
   * Create a new {@code nth-*} pseudo-class instance with the specified value
   * and argument.
   * 
   * @param value The {@code nth-*} pseudo-class value (i.e. {@code nth-child}
   *          etc).
   * @param argument The {@code nth-*} pseudo-class argument (i.e. {@code odd}
   *          etc).
   */
