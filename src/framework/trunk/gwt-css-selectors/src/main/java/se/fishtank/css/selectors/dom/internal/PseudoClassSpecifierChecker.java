 ...
 * {@linkplain PseudoClassSpecifier pseudo-class specifier} set.
 * 
...
public class PseudoClassSpecifierChecker extends NodeTraversalChecker {
	 ...
	 * 
	 * @see <a
	 *      href="http://www.w3.org/TR/css3-selectors/#empty-pseudo"><code>:empty</code>
	 *      pseudo-class</a>
	 */
	 ...
	 * 
	 * @see <a
	 *      href="http://www.w3.org/TR/css3-selectors/#last-child-pseudo"><code>:last-child</code>
	 *      pseudo-class</a>
	 */
	 ...
	 * 
	 * @see <a
	 *      href="http://www.w3.org/TR/css3-selectors/#only-child-pseudo"><code>:only-child</code>
	 *      pseudo-class</a>
	 */
	private void addOnlyChildElements() {
		for (Node node : nodes) {
			if (DOMHelper.getPreviousSiblingElement(node) == null && DOMHelper.getNextSiblingElement(node) == null) {
				result.add(node);
			}
		}
	}
	 ...
	 * 
	 * @see <a
	 *      href="http://www.w3.org/TR/css3-selectors/#root-pseudo"><code>:root</code>
	 *      pseudo-class</a>
	 */
