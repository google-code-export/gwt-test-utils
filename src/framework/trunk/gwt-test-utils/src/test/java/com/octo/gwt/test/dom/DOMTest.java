...
public class DOMTest extends GwtTestTest {
	...
	public void createSelect() {
		...
		assertFalse("Simple SelectElement should not be multiple",
				elem.isMultiple());
	}
	...
	public void setStyleAttribute() {
		// Arrange
		com.google.gwt.user.client.Element e = Document.get().createAnchorElement().cast();

		// Act
		DOM.setStyleAttribute(e, "width", "10px");

		// Assert
		assertEquals("10px", DOM.getStyleAttribute(e, "width"));
	}
