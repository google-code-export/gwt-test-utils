...
public interface MyMessages extends Messages {
	...
	//	@AlternateMessage({ "FEMALE", "{0} likes her widgets.", "MALE", "{0} likes his widgets.", })
	//	String alternateMessageWithSelect(String name, @Select Gender gender);
	//
	//	@DefaultMessage("{0} gave away their {2} widgets")
	//	@AlternateMessage({ "MALE|other", "{0} gave away his {2} widgets", "FEMALE|other", "{0} gave away her {2} widgets", "MALE|one",
	//			"{0} gave away his widget", "FEMALE|one", "{0} gave away her widget", "other|one", "{0} gave away their widget", })
	//	String alternateMessageWithSelectAndPluralCount(String name, @Select Gender gender, @PluralCount int count);
