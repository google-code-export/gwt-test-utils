...
/**
 * <p>
 * An interface which exposes one callback method to be called when an exception
 * occurs during a RPC service invocation.
 * </p>
 * 
 * <p>
 * The used instance of GwtRpcExceptionHandler is specified by
 * {@link RemoteServiceCreateHandler#getExceptionHandler()}, which can be
 * overriden.
 * </p>
 * 
...
public interface GwtRpcExceptionHandler {
	 ...
	 * @param callback
	 *            The asynchrone callback provided by the RPC service caller.
	 */
