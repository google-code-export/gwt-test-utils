...
public class MockHttpServletRequest implements HttpServletRequest {
   ...
   public void addParameters(Map<?, ?> params) {
      ...
      for (Object key : params.keySet()) {
         assertThat(key).as("Parameter map key must be of type [" + String.class.getName() + "]").isInstanceOf(
                  String.class);
   ...
   public void addPreferredLocale(Locale locale) {
      assertThat(locale).as("Locale must not be null").isNotNull();
   ...
   public long getDateHeader(String name) {
      ...
      if (value instanceof Date) {
         ...
         throw new IllegalArgumentException("Value for header '" + name
                  + "' is neither a Date nor a Number: " + value);
      } else {
         return -1L;
      }
   }
   ...
   public Enumeration<String> getHeaders(String name) {
      HeaderValueHolder header = HeaderValueHolder.getByName(this.headers, name);
      return Collections.enumeration(header != null ? header.getStringValues()
   ...
   public int getIntHeader(String name) {
      ...
      if (value instanceof Number) {
         ...
         throw new NumberFormatException("Value for header '" + name + "' is not a Number: "
                  + value);
      } else {
         return -1;
      }
   ...
   public BufferedReader getReader() throws UnsupportedEncodingException {
      if (this.content != null) {
         ...
         Reader sourceReader = (this.characterEncoding != null) ? new InputStreamReader(
                  sourceStream, this.characterEncoding) : new InputStreamReader(sourceStream);
