 ...
 * the License.
 */
package com.googlecode.html.xercesbridge;
...
/**
 * This class allows to transparently handle Xerces methods that have changed
 * among versions.
 * 
...
public abstract class XercesBridge {
    ...
    * 
    * @return the instance corresponding to the Xerces version being currently
    *         used.
    */
   ...
   private static XercesBridge makeInstance() {
      final String[] classNames = {
               "com.googlecode.html.xercesbridge.XercesBridge_2_3",
               "com.googlecode.html.xercesbridge.XercesBridge_2_2",
               "com.googlecode.html.xercesbridge.XercesBridge_2_1",
               "com.googlecode.html.xercesbridge.XercesBridge_2_0"};
    ...
    * @param avalue
    */
   public void NamespaceContext_declarePrefix(NamespaceContext namespaceContext, String ns,
            String avalue) {
      // nothing
   }
    ...
    */
   public abstract void XMLDocumentHandler_startDocument(XMLDocumentHandler documentHandler,
