...
// Code copy paste from Properties class from JDK 1.6, and add the sequenceReplacement stuff
...
public class LoadPropertiesHelper {
	...
	private static void load0(Properties properties, LineReader lr) throws IOException {
		...
		while ((limit = lr.readLine()) >= 0) {
			...
			for (SequenceReplacement strangeCharacterMapping : sequenceReplacementList) {
				value = strangeCharacterMapping.treat(value);
			}
