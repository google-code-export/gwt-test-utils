   ...
   public Object create(Class<?> classLiteral) throws Exception {
      ...
      InvocationHandler ih = new InvocationHandler() {
         ...
         public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            // escape simple quote
            String templateValue = MessageFormat.format(template.value().replaceAll("'", "''"),
                     newArgs);
      ...
      return Proxy.newProxyInstance(classLiteral.getClassLoader(), new Class<?>[]{classLiteral}, ih);
