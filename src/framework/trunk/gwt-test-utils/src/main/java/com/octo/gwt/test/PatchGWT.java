...
import com.octo.gwt.test.internal.PatchAnchorElement;
import com.octo.gwt.test.internal.PatchCheckBox;
import com.octo.gwt.test.internal.PatchComplexPanel;
import com.octo.gwt.test.internal.PatchCurrencyList;
import com.octo.gwt.test.internal.PatchDOM;
import com.octo.gwt.test.internal.PatchDOMImpl;
import com.octo.gwt.test.internal.PatchDeferredCommand;
import com.octo.gwt.test.internal.PatchDocument;
import com.octo.gwt.test.internal.PatchDuration;
import com.octo.gwt.test.internal.PatchElement;
import com.octo.gwt.test.internal.PatchElementMapperImpl;
import com.octo.gwt.test.internal.PatchFlexTable;
import com.octo.gwt.test.internal.PatchFrame;
import com.octo.gwt.test.internal.PatchGrid;
import com.octo.gwt.test.internal.PatchHTMLTable;
import com.octo.gwt.test.internal.PatchImage;
import com.octo.gwt.test.internal.PatchInputElement;
import com.octo.gwt.test.internal.PatchLabelElement;
import com.octo.gwt.test.internal.PatchListBox;
import com.octo.gwt.test.internal.PatchMainGWT;
import com.octo.gwt.test.internal.PatchNode;
import com.octo.gwt.test.internal.PatchNodeList;
import com.octo.gwt.test.internal.PatchNumberFormat;
import com.octo.gwt.test.internal.PatchTextArea;
import com.octo.gwt.test.internal.PatchTextBox;
import com.octo.gwt.test.internal.PatchTextBoxImpl;
import com.octo.gwt.test.internal.PatchTimer;
import com.octo.gwt.test.internal.PatchUIObject;
import com.octo.gwt.test.internal.PatchURL;
...
import com.octo.gwt.test.internal.overrides.OverrideHistory;
...
public class PatchGWT {
	...
	public static void init() throws Exception {
		...
		try {
			Class.forName(PatchUtils.REDEFINE_CLASS);
		} catch (ClassNotFoundException e) {
			throw new RuntimeException("Unable to load " + PatchUtils.REDEFINE_CLASS + " class, you probably forgot to "
		...
		PatchUtils.applyPatches(GWT.class,
				new Patch[] { new PatchMethod("log", staticCall(PatchMainGWT.class, "log", "$1, $2")).setArgClasses(new Class[] { String.class, Throwable.class }),
		...
		PatchUtils.applyPatches(FocusImplStandard.class, new Patch[] {
...
//				new PatchMethod("blur", ""), 
		...
		PatchUtils.applyPatches(CurrencyDataImpl.class, new Patch[] {
