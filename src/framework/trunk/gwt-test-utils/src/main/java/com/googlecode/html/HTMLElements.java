...
public class HTMLElements {
   ...
   static {
      ...
      ELEMENTS_ARRAY['F' - 'A'] = new Element[]{
               ...
               new Element(FORM, "FORM", Element.CONTAINER, new short[]{BODY, TD, DIV},
                        new short[]{BUTTON, P}),
               // FRAME - O EMPTY
      ...
      ELEMENTS_ARRAY['H' - 'A'] = new Element[]{
               ...
               new Element(H1, "H1", Element.BLOCK, new short[]{BODY, A}, new short[]{
                        H1, H2, H3, H4, H5, H6, P}),
               new Element(H2, "H2", Element.BLOCK, new short[]{BODY, A}, new short[]{
                        H1, H2, H3, H4, H5, H6, P}),
               new Element(H3, "H3", Element.BLOCK, new short[]{BODY, A}, new short[]{
                        H1, H2, H3, H4, H5, H6, P}),
               new Element(H4, "H4", Element.BLOCK, new short[]{BODY, A}, new short[]{
                        H1, H2, H3, H4, H5, H6, P}),
               new Element(H5, "H5", Element.BLOCK, new short[]{BODY, A}, new short[]{
                        H1, H2, H3, H4, H5, H6, P}),
               new Element(H6, "H6", Element.BLOCK, new short[]{BODY, A}, new short[]{
                        H1, H2, H3, H4, H5, H6, P}),
      ...
      ELEMENTS_ARRAY['S' - 'A'] = new Element[]{
               ...
               // STYLE - - %StyleSheet;
               new Element(STYLE, "STYLE", Element.SPECIAL, new short[]{HEAD, BODY}, new short[]{
                        STYLE, TITLE, META}),
               // SUB - - (%inline;)*
      ...
      ELEMENTS_ARRAY['T' - 'A'] = new Element[]{
               ...
               // TBODY O O (TR)+
               new Element(TBODY, "TBODY", 0, TABLE, new short[]{
                        THEAD, TBODY, TFOOT, TD, TH, TR, COLGROUP}),
               // TD - O (%flow;)*
               ...
               // THEAD - O (TR)+
               new Element(THEAD, "THEAD", 0, TABLE, new short[]{
                        THEAD, TBODY, TFOOT, TD, TH, TR, COLGROUP}),
