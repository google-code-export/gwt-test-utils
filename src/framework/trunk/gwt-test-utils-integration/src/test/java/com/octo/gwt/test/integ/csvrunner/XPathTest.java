...
public class XPathTest {
	...
	@Test
	public void testB() {
		Assert.assertEquals("/toto/tata/tete/titi", processString("/toto/tata/tete/titi").toString());
	...
	@Test
	public void testD() {
		Assert.assertEquals("/toto(aa bb,zz,)/titi/toto", processString("/toto(aa bb,zz)/titi/toto").toString());
	}

	@Test
	public void testE() {
		Assert.assertEquals("/toto/tata{zyy}", processString("/toto/tata[zyy]").toString());
	}

	@Test
	public void testF() {
		Assert.assertEquals("/toto/tata{zz yy}", processString("/toto/tata[zz yy]").toString());
	}

	@Test
	public void testG() {
		Assert.assertEquals("/toto/tata[/aa=zz yy]", processString("/toto/tata[aa=zz yy]").toString());
	}

	@Test
	public void testH() {
		Assert.assertEquals("/toto/tata[/aa/zz(b,)/toto=zz yy]", processString("/toto/tata[aa/zz(b)/toto=zz yy]").toString());
	}

	@Test
	public void testI() {
		Assert.assertEquals("/toto/tata[/aa/zz[/b=2]/toto=zz yy]", processString("/toto/tata[aa/zz[b=2]/toto=zz yy]").toString());
	}
